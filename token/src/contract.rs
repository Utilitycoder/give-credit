...
use crate::nftmint::{mint as nft_mint, balance_of};
...
#[contractimpl]
impl Token {
    pub fn initialize(e: Env, admin: Address, address: Address, decimal: u32) {
        let name = String::from_slice(&e, "USDC");
        let symbol = String::from_slice(&e, "USDC");

        let nftname = String::from_slice(&e, "Give Credit Token");
        let nftsymbol = String::from_slice(&e, "GCT");

        e.storage().persistent().set(&PUB_NODE_ADD, &address);
        ...
        erc721::ERC721Contract::initialize(e, admin, nftname, nftsymbol);
    }
...
impl token::Interface for Token {
    ...
    fn transfer(e: Env, from: Address, to: Address, amount: i128) {
        ...
        nft_mint(&e, from.clone(), String::from_slice(&e, "amount"));
