...
// fn create_token<'a>(e: &Env, admin: &Address, pub_node: &Address, stellar_carbon: &Address) -> Clients<'a> {
...
//     token.initialize(admin, pub_node, &nft_contract_id, &stellar_carbon);
//     Clients { token, nft }
// }
...
//     let client = create_token(&e, &admin1, &pub_node, &stellar_carbon);
