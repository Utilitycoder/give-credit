...
impl storage::Storage for Admin {
    ...
    fn bump(&self, env: &Env, min_ledger_to_live: u32, high_expiration_watermark: u32) -> &Self {
        storage::Persistent::bump(env, self, min_ledger_to_live, high_expiration_watermark);
        self
    }
    fn bump_until(&self, env: &Env, expiration_ledger: u32, high_expiration_watermark: u32) -> &Self {
        storage::Persistent::bump_until(env, self, expiration_ledger, high_expiration_watermark);
        self
    }
...
impl Storage for DataKey {
    ...
    fn bump(&self, env: &Env, min_ledger_to_live: u32, high_expiration_watermark: u32) -> &Self {
        match self {
            ...
            DataKey::Approved(_) | DataKey::Operator(_, _) => {
                storage::Temporary::bump(env, self, min_ledger_to_live, high_expiration_watermark)
            }
        };
        self
    }
    fn bump_until(&self, env: &Env, min_ledger_to_live: u32, high_expiration_watermark: u32) -> &Self {
        match self {
            DataKey::Balance(_) | DataKey::TokenOwner(_) => {
                storage::Persistent::bump_until(env, self, min_ledger_to_live, high_expiration_watermark)
            }
            DataKey::Approved(_) | DataKey::Operator(_, _) => {
                storage::Temporary::bump_until(env, self, min_ledger_to_live, high_expiration_watermark)
            }
        };
        self
    }
...
impl storage::Storage for DatakeyMetadata {
    ...
    fn bump(&self, env: &Env, min_ledger_to_live: u32, high_expiration_watermark: u32) -> &Self {
        storage::Instance::bump(env, min_ledger_to_live, high_expiration_watermark);
        self
    }
    fn bump_until(&self, env: &Env, min_ledger_to_live: u32, high_expiration_watermark: u32) -> &Self {
        storage::Instance::bump_until(env, min_ledger_to_live, high_expiration_watermark);
        self
    }
...
impl storage::Storage for DataKeyEnumerable {
    ...
    fn bump_until(&self, env: &Env, expiration_ledger: u32, high_expiration_watermark: u32) -> &Self {
        storage::Instance::bump_until(env, expiration_ledger, high_expiration_watermark);
        self
    }
